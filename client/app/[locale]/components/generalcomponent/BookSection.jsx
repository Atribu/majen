...
const BookSection = () => {
  ...
  const whatsappText = encodeURIComponent(footerT("whatsappText"));
  ...
  return (
    ...
    target="_blank" rel="noopener noreferrer" aria-label={socialT("whatsappAction")} title={socialT("whatsappAction")} className='flex w-[50px] h-[50px] lg:w-[60px] lg:h-[60px] relative rounded-full border-white border ml-6 lg:ml-7 text-white bg-black/70 hover:bg-white hover:border-black hover:text-[#f5e1c6] items-center justify-center animate-zoom cursor-pointer'>
