...
export default function StatsSection() {
  ...
  return (
    <section className="bg-white py-16">
      <div className="flex flex-col lg:flex-row max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-900 justify-between">
        {/* Başlık */}
       <div className="w-[20%]">
       <h2 className="mt-1 text-3xl md:text-4xl lg:text-[48px] font-bold">
        ...
        {/* İstatistikler */}
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-8 w-[75%]">
